...
class Game {
  ...
  addStartPlatform() {
    this.add(new Platform({ game: this, width: 200, pos: [50, 260], vel: [-6, 0] }));
    this.add(new Platform({ game: this, width: 200, pos: [200, 260], vel: [-6, 0] }));
    this.add(new Platform({ game: this, width: 200, pos: [350, 260], vel: [-6, 0] }));
  }
