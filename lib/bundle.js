...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  ...
	  addStartPlatform() {
	    this.add(new Platform({ game: this, width: 300, pos: [100, 100], vel: [-6, 0] }));
	    this.add(new Platform({ game: this, width: 300, pos: [200, 100], vel: [-6, 0] }));
	    this.add(new Platform({ game: this, width: 300, pos: [300, 100], vel: [-6, 0] }));
...
/***/ function(module, exports) {
	...
	class Background {
	  constructor() {
	    ...
	    this.height = 600;
	    this.speed = -1.5;
	    this.path = 'assets/images/bg4.png';
